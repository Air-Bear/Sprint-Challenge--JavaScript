...
zooAnimals.forEach(animal => displayNames.push(animal.animal_name));
...
*/
const populationTotal = zooAnimals.reduce((populationTotal, animal) => {return populationTotal + animal.population}, 0);
